...
const BmiCalculator = () => {
  ...
  }, [height, weight]) // useEffect hooks with dependency array
  useEffect(() => {
    localStorage.setItem('height', JSON.stringify(height))
    console.log('height is updated') // useEffect hooks with dependency array
  }, [height])
  useEffect(() => {
    localStorage.setItem('weight', JSON.stringify(weight))
    console.log('weight is updated') // useEffect hooks with dependency array
  }, [weight])
